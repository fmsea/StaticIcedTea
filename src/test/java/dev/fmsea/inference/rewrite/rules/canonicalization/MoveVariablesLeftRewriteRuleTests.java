...
public class MoveVariablesLeftRewriteRuleTests extends RewriteRuleTests {

    @BeforeEach
    public void setup() {
        this.rule = new MoveVariablesLeftRewriteRule();
    }

    @ParameterizedTest
    @MethodSource("moveVariablesLeftExpressions")
