...
public class OctagonNumericalTest extends AbstractNumericalTest {
    ...
    public void testNumericalAnalysis(Body body, String resourceOracle) {
        IntegerAnalysis  analysis = new IntegerAnalysis(body, 2, DefaultOctagonState.class);
        analysis.runAnalysis();
        String actual = generateReport(analysis).trim();
        String expected = readResourcesFile(resourceOracle).trim();
