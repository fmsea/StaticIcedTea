...
public class ZoneChangedVariableVisitorTest {

    static final ZoneChangedVariableVisitor deltaVisitor = new ZoneChangedVariableVisitor();
    ...
    private static Stream<Arguments> provideArguments() {
        return Stream.of(
            Arguments.of(TADRReader.parse("(= x (+ y z))"), Set.of(Locals.get("x"))),
            ...
            Arguments.of(TADRReader.parse("(= x (- y z))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (- 3 y))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (- y 3))"), Locals.get("x", "y")),
            Arguments.of(TADRReader.parse("(= x (- (- y) z))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (- y (- z)))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (- (- y) 3))"), Locals.get("x", "y")),
            ...
            Arguments.of(TADRReader.parse("(= x (* y z))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (* 3 y))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (* y 3))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (* (- y) z))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (* y (- z)))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (* (- y) 3))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= x (* 3 (- y)))"), Set.of(Locals.get("x"))),
            ...
            Arguments.of(TADRReader.parse("(= (- x) 3)"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(= 3 (- x))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(not (= x y))"), Locals.get("x", "y")),
            Arguments.of(TADRReader.parse("(not (= y x))"), Locals.get("x", "y")),
            Arguments.of(TADRReader.parse("(not (= (- x) y))"), Locals.get("x", "y")),
            Arguments.of(TADRReader.parse("(not (= y (- x)))"), Locals.get("x", "y")),
            Arguments.of(TADRReader.parse("(not (= x 3))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(not (= 3 x))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(not (= (- x) 3))"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(not (= 3 (- x)))"), Set.of(Locals.get("x"))),
            ...
            Arguments.of(TADRReader.parse("(> (- x) 3)"), Set.of(Locals.get("x"))),
            Arguments.of(TADRReader.parse("(> 3 (- x))"), Set.of(Locals.get("x"))),
            Arguments.of(TADR.newNeExpr(TADR.from(Locals.get("x")), TADR.from(Locals.get("y"))), Locals.get("x", "y"))
        );
    }
}
