...
public class DifferenceBoundedStateProperties {
    ...
    void copyToBringsEdges(@ForAll @NotEmpty @UniqueElements(by = LocalProvider.Unique.class) Set<Local> locals,
        ...
        for (int i = 0; i < N2; i++) {
            Assertions.assertEquals(c, target.getConstraint(xs[i], xs[(i + 1)]));
        }
        for (Local l : locals) {
            Assertions.assertEquals(Constraint.TOP(), target.getConstraint(l));
        }
    ...
    void updateStateConstantAssignment(@ForAll int x, @ForAll int y) {
        ...
        Assertions.assertEquals(new Constraint(y, PredicateType.Eq), state.getConstraint(x0));
    }
    ...
    void updateStateAliasAssignment(@ForAll Local a, @ForAll Local b) {
        ...
        Assertions.assertEquals(new Constraint(0, PredicateType.Eq), state.getConstraint(a, b));
    }

    @Property
    void updateStateUpdateRelationsAddition(
    ...
    void testIncrementalClosure(@ForAll @IntRange(min = -536870911, max = 536870911) int c,
        ...
        Assertions.assertEquals(new Constraint(c + k + w + v, PredicateType.Le),
    ...
    void updateVariableSubtraction(@ForAll @IntRange(min = -536870911, max = 536870911) int c,
        ...
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[0], xs[1]));
    }
    ...
    void updateVariableMultiplication(@ForAll int c) {
        ...
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[0], xs[1]));
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[0]));
    ...
    void transferTwoVariablesSubtraction(@ForAll @IntRange(min = -536870911, max = 536870911) int c) {
        ...
        Assertions.assertEquals(new Constraint(c, PredicateType.Le), state.getConstraint(xs[2]));
    }
    ...
    void transferTwoVariablesMultiplication(@ForAll int c) {
        ...
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[2]));
    }
    ...
    void assignmentKillsExistingRelationships(@ForAll Constraint a, @ForAll Constraint b,
        ...
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[0], xs[1]));
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[2], xs[0]));
        Assertions.assertEquals(Constraint.TOP(), state.getConstraint(xs[0], xs[3]));
    }
}
