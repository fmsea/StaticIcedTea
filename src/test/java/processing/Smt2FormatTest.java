...
public class Smt2FormatTest extends FormatTest {
    ...
    void testSMT2FormatSimple() {
        ...
        try {
            Smt2Format.SMT2Format(r1, r2, w1);
            assertEquals(ResourceFileUtility.readResourcesFile("processing/format.simple.out"),
                         w1.toString());
        } catch (IOException e) {
            e.printStackTrace(System.err);
            assertTrue(false);
    ...
    void testSMT2FormatUnbalanced() {
        ...
        try {
            Smt2Format.SMT2Format(r1, r2, w1);
            assertEquals(ResourceFileUtility.readResourcesFile("processing/format.unbalanced.out"),
                         w1.toString());
    ...
    void testSMT2FormatUnchanged() {
        ...
        try {
            Smt2Format.SMT2Format(r1, r2, w1);
            assertEquals(ResourceFileUtility.readResourcesFile("processing/format.unchanged.out"),
                         w1.toString());
        } catch (IOException e) {
            e.printStackTrace(System.err);
            assertTrue(false);
    ...
    void testSMT2FormatIdentifiers() {
        ...
        try {
            ...
            assertEquals(ResourceFileUtility.readResourcesFile("processing/format.identifiers.out"),
                         w1.toString());
        } catch (IOException ex) {
            ex.printStackTrace(System.err);
            assertTrue(false);
    ...
    void testSMT2FormatQuotes() {
        ...
        try {
            Smt2Format.SMT2Format(r1, r2, w1);
            assertEquals(ResourceFileUtility.readResourcesFile("processing/format.quotes.out"),
                         w1.toString());
        } catch (IOException ex) {
            ex.printStackTrace(System.err);
            assertTrue(false);
    ...
    void testSMT2FormatFull() {
        {
            ...
            try {
                Smt2Format.SMT2Format(r1, r2, w1);
                assertEquals(ResourceFileUtility.readResourcesFile("processing/format.full.simple.out"),
                             w1.toString());
            } catch (IOException ex) {
                ex.printStackTrace(System.err);
                assertTrue(false);
    ...
    void testSMT2FormatStatementsSorted() {
        {
            ...
            try {
                Smt2Format.SMT2Format(r1, r2, w1);
                assertEquals(ResourceFileUtility.readResourcesFile("processing/format.full.sorted.out"),
                             w1.toString());
            } catch (IOException ex) {
                ex.printStackTrace(System.err);
                assertTrue(false);
