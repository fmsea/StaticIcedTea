...
public class FormatMinReachableTestProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context)
        ...
        return Stream.of(Arguments.arguments(getReader("processing/format.min.full.in"),
                         ...
                         Arguments.arguments(getReader("processing/format.reachable.full.in"),
                                             getReader("processing/format.reachable.changed.in"),
                                             getReader("processing/format.reachable.full.in"),
                                             getReader("processing/format.reachable.changed.in"),
                                             getContents("processing/format.reachable.smt.out")));
    }
}
