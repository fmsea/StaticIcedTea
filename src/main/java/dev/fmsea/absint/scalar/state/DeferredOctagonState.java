...
import dev.fmsea.absint.scalar.state.update.DeferredOctagonRefineThunkVisitor;
import dev.fmsea.absint.scalar.state.update.DeferredOctagonRefiner;
import dev.fmsea.absint.scalar.state.update.DeferredOctagonThunkVisitor;
import dev.fmsea.absint.scalar.state.update.DeferredOctagonUpdater;
