...
import dev.fmsea.absint.scalar.state.update.DeferredIncrementalOctagonRefineThunkVisitor;
import dev.fmsea.absint.scalar.state.update.DeferredIncrementalOctagonRefiner;
import dev.fmsea.absint.scalar.state.update.DeferredIncrementalOctagonThunkVisitor;
import dev.fmsea.absint.scalar.state.update.DeferredIncrementalOctagonUpdater;
