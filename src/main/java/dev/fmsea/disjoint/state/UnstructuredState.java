package dev.fmsea.disjoint.state;
...
/**
 * This class is to contains set of predicates
...
public class UnstructuredState implements State {
    ...
    public UnstructuredState() {
        varToValue = new HashMap<Value, List<Set<BitSet>>>();
    }

    public UnstructuredState(Map<Value, List<Set<BitSet>>> map) {
        varToValue = new HashMap<Value, List<Set<BitSet>>>();
    ...
    public State copy() {
        ...
        return new UnstructuredState(varToValue);
    }
    ...
    public State merge(State state) {
        UnstructuredState ret = null;
        // System.out.println("MergingU " + state + " " + this);
        if (state instanceof UnstructuredState) {
            UnstructuredState other = (UnstructuredState) state;
            ...
            for (Value var : varToValue.keySet()) {
                ...
                ret = new UnstructuredState(mergedVarToValue);
            }
    ...
    public boolean equals(Object o) {
        boolean ret = false;
        if (o instanceof UnstructuredState) {
            UnstructuredState other = (UnstructuredState) o;
