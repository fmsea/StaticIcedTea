...
public class StartAnalysisOld {
    ...
    public static void main(String[] args) {
        // String[] classNames = {"test.BallonFactory", "test.OneTcas", "test.Base64",
        // "test.client", "test.GeoData", "test.GeoEngine",
        // "test.InfBlocks", "test.InfCodes", "test.InfTree", "test.MapViewer",
        // "test.QRCodeDataBlockReader",
        // "test.StructurePanel", "test.TileRenderor", "test.WorldController",
        // "test.Class11", "test.Class13",
        // };
            ...
            for (String symbolicOn : symbolic) {
                for (String domainName : domainNames) {
                    try {
                        ...
                        new StartAnalysisOld(className, domainName, symbolicOn);
                        G.reset();
                        System.gc();
                    } catch (Exception e) {
                        // TODO Auto-generated catch block
    ...
    public StartAnalysisOld(String className, String domainFile, String symbolicHelper) throws IOException {
        ...
        PackManager.v().getPack("jtp").add(new Transform("jtp.disjoint", new ValueTransformer(domain, 2, symbolicOn)));
