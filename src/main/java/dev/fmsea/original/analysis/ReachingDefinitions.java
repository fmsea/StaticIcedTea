package dev.fmsea.original.analysis;
...
public class ReachingDefinitions {
    ...
    // private Map unitToExpresionAfter; //mapping each unit to reach expression
    // after
    ...
    public ReachingDefinitions(UnitGraph graph) {
        ...
        // ReachingDefinitionsOriginal analysis = new ReachingDefinitionsOriginal(graph,
        // "allBranches");

        unitToExpressionsBefore = new HashMap(graph.size() * 2 + 1, 07.f); // I don't understand this code
        // unitToExpressionsFall = new ArrayList <HashMap<Local, Set<Unit>>>(); //I
        // don't understand this code
        // unitToExpressionsBranch = new HashMap(graph.size() * 2 + 1, 07.f); //I don't
    ...
    public String getReachableExpressions(Unit s, String type) {
        ...
        // return (List) unitToExpressionsBefore.get(s); //can it convert a map into a
        // list? not sure
    }
