...
import dev.fmsea.conditional.analysis.ConditionalValue;
...
public class StartConditionalValue {
    ...
    public StartConditionalValue(String className, String domainFile, /* String symbolicHelper, */ String condition,
        ...
        if (writeToFile) {
            String fileName = resultsPath + className + "_" + methodId + "_" + condition.replaceAll(",", "") + "_"
                    + domainFile;
        ...
        PackManager.v().getPack("jtp").add(
                new Transform("jtp.disjoint", new ConditionalValue(domain, Integer.parseInt(methodId), condition)));
