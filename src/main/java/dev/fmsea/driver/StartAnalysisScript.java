...
public class StartAnalysisScript {
    ...
    public StartAnalysisScript(String className, String domainFile, String symbolicHelper, String condition,
        ...
        String fileName = resultsPath + className + "_" + methodId + "_"
                + (condition.isEmpty() ? "" : condition.replaceAll(",", "") + "_") + domainFile;
