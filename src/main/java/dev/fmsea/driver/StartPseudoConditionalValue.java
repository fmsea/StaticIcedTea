...
import dev.fmsea.pseudo.analysis.PseudoCondtionalValue;
...
public class StartPseudoConditionalValue {
    ...
    public static void main(String[] args) {
        ...
        // File file = new
        // File("./ExperimentDataConditional/conditions/paths/"+classNames[0]+"_"+methodId+".txt");
        // if(file.exists()){
        // try {
    ...
    public StartPseudoConditionalValue(String className, String domainFile, String symbolicHelper, String condition,
