...
import dev.fmsea.pseudo.analysis.PseudoConditionalReachingDefinitions;
import soot.Body;
import soot.Scene;
...
public class StartPseudoConditionalReachingDefinitions {
    ...
    public static void main(String[] args) {
        ...
        // File file = new
        // File("./ExperimentDataConditional/conditions/paths/"+className+"_"+methodId+".txt");
        // if(file.exists()){
        // try {
        ...
        for (String condition : conditions) {
            ...
            // sootClp =
            // sootClp.replace("/Library/Java/JavaVirtualMachines/jdk1.7.0_80.jdk/Contents/Home/jre/../Classes/classes.jar:/Library/Java/JavaVirtualMachines/jdk1.7.0_80.jdk/Contents/Home/jre/../Classes/ui.jar:",
            // "");
            ...
            // //sootClp
            // +=":/Users/erickeefe/Documents/workspace/Conditional_DFA/artifacts/test";
            ...
            try {
                ...
                // String path =
                // "/Users/erickeefe/Documents/workspace/Conditional_DFA/src/automatedTesting/";
                ...
                if (writeInv) {
                    ...
                    while (gIt.hasNext()) {
                        ...
                        // System.out.println("Reachable Defitions " + flowTypes[i] + " this unit
                        // are:");
                        // String sep = "";
