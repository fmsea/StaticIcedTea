...
public class OctagonGeAdditionRule extends RewriteRule {
    ...
    public Stream<TADR> rewrite(GeCmp expr, Function<Local, Interval32Box> lookup) {
        ...
        if (right.left instanceof Variable && right.right instanceof Variable) {
            ...
            return Stream.of(TADR.newLeExpr(right.left, TADR.newAddExpr(expr.left, r.expr)));
            ...
            return Stream.of(TADR.newLeExpr(right.right, TADR.newAddExpr(expr.left, l.expr)));
        }
