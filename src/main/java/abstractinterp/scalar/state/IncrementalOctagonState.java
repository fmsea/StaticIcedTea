...
import abstractinterp.scalar.state.update.IncrementalOctagonRefineThunkVisitor;
import abstractinterp.scalar.state.update.IncrementalOctagonRefiner;
import abstractinterp.scalar.state.update.IncrementalOctagonThunkVisitor;
import abstractinterp.scalar.state.update.IncrementalOctagonUpdater;
