...
public class DeferredIncrementalOctagonRefineThunkVisitor extends IncrementalOctagonRefineThunkVisitor {

    private List<ConstraintUpdateThunk> updates;

    public DeferredIncrementalOctagonRefineThunkVisitor() {
        super();
    ...
    public boolean finalize(OctagonDifferenceBoundedMatrix m, OctagonDifferenceBoundedMatrix in) {
        ...
        boolean result = m.incrementalClosure(this.updates, in);
