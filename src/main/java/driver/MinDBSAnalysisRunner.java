...
public class MinDBSAnalysisRunner implements Runnable {
    private static final Logger LOGGER = LoggerFactory.getLogger(MinDBSAnalysisRunner.class);
    ...
    private final IntegerAnalysis<MinDifferenceBoundedState> analysis;
    ...
    public MinDBSAnalysisRunner(String className,
        ...
        this.analysis = new IntegerAnalysis<>(this.body, 2, new MinDifferenceBoundedStateFactory());
    }
