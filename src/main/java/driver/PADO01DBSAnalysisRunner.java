...
public class PADO01DBSAnalysisRunner implements Runnable {
    private static final Logger LOGGER = LoggerFactory.getLogger(PADO01DBSAnalysisRunner.class);
    ...
    private final IntegerAnalysis<PADO01DifferenceBoundedState> analysis;
    ...
    public PADO01DBSAnalysisRunner(String className,
        ...
        this.analysis = new IntegerAnalysis<>(this.body, 2, new PADO01DifferenceBoundedStateFactory());
    }
