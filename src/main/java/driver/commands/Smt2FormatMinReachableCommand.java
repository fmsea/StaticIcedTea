...
import processing.Smt2FormatMinReachable;

@Command(name = "smt2-format-min-reachable",
         mixinStandardHelpOptions=true,
         description = "create SMT formula to (assert (=> f1 f2))")
public class Smt2FormatMinReachableCommand implements Callable<Integer> {
    ...
    public Integer call() {
        ...
        try (Reader oneFull = new FileReader(analysisOneFull.toFile());
            ...
            Smt2FormatMinReachable.Smt2FormatMinReachable(oneFull,
                                                          oneChanged,
                                                          twoFull,
                                                          twoChanged,
                                                          out);
