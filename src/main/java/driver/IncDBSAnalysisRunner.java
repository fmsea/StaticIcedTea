...
public class IncDBSAnalysisRunner implements Runnable {
    private static final Logger LOGGER = LoggerFactory.getLogger(IncDBSAnalysisRunner.class);
    ...
    private final IntegerAnalysis<IncDifferenceBoundedState> analysis;
