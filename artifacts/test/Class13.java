...
//    }
    ...
    private static void method226(byte byte4, int i, int j,int k,  int ai[], int l, byte abyte0[], int i1,  int j1    ) {
        int k1 = j1;
        int l1 = 602;
        label0:
        do {
...
//                if (byte1 == 1) {
//                    class32.aBooleanArray590[j] = true;
//                } else {
//                    class32.aBooleanArray590[j] = false;
//                }
//            }
//
//            for (int k = 0; k < 256; k++) {
...
//            class32.anInt601 = i6;
//            method226(class32);
//            if (class32.anInt584 == class32.anInt601 + 1 && class32.anInt574 == 0) {
//                flag19 = true;
//            } else {
//                flag19 = false;
//            }
