...
public class WBS {
	...
	public int update(int PedalPos, boolean AutoBrake,
			boolean Skid, int WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE, int WBS_Node_WBS_BSCU_rlt_PRE1, 
			int WBS_Node_WBS_rlt_PRE2) {
		...
		int Nor_Pressure; int Alt_Pressure; int Sys_Mode;
	   ...
	   return Nor_Pressure + Alt_Pressure + Sys_Mode; 
	...
	public static void main(String[] args) {
		...
		int par6 = 100;
		if(args.length == 6){
		PedalPos=Integer.parseInt(args[0]+"");
		AutoBrake= Boolean.parseBoolean(args[1]+"");
		Skid=Boolean.parseBoolean(args[2]+"");
		par4=Integer.parseInt(args[3]+"");
		par5=Integer.parseInt(args[4]+"");
		par6=Integer.parseInt(args[5]+"");
		}
		
//		System.out.println(PedalPos + " " + AutoBrake + " " + Skid + " " + par4 + " "
//				+ par5 + " " + par6);
		
		int res = wBS.update(PedalPos, AutoBrake, Skid, par4, par5, par6);
...
//
//		System.out.println(wBS.Alt_Pressure + " " + wBS.Nor_Pressure + " " + wBS.Sys_Mode + " " + wBS.WBS_Node_WBS_BSCU_rlt_PRE1 + " "
//				+ wBS.WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE + " " + wBS.WBS_Node_WBS_rlt_PRE2);
//
